...
CREATE TRIGGER __reorder_ordered_list AFTER INSERT OR DELETE OR UPDATE OF order_in_chapter ON public.api_component FOR EACH ROW EXECUTE PROCEDURE public.__reorder_ordered_list('order_in_chapter', 'fk_component_id', 'fk_chapter_id');
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_book FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_chapter FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_chaptertitle FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_character FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_comment FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_component FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_componenttype FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_language FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_media FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_profile FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_text FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_translation FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_word FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_wordgroup FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_wordgrouptitle FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_creation_date BEFORE INSERT ON public.api_wordtranslation FOR EACH ROW EXECUTE PROCEDURE public.__set_creation_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_book FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_chapter FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_chaptertitle FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_character FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_comment FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_component FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_componenttype FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_language FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_media FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_profile FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_text FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_translation FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_word FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_wordgroup FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_wordgrouptitle FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
CREATE TRIGGER __set_modified_date BEFORE UPDATE ON public.api_wordtranslation FOR EACH ROW EXECUTE PROCEDURE public.__set_modified_date();
ALTER TABLE ONLY public.api_chapter
