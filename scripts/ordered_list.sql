   ...
   _self_ref_column_name := TG_ARGV[1];
    ...
    IF  (TG_OP = 'UPDATE') THEN
    	...
    	IF _new_order < _old_order then
            EXECUTE format('UPDATE %1$I.%2$I SET %3$I = %3$I + 1 WHERE id <> $1.id AND %3$I >= $1.%3$I AND %3$I < $2.%3$I AND %4$I IS NOT DISTINCT FROM $2.%4$I', TG_TABLE_SCHEMA, TG_TABLE_NAME, _column_name, _self_ref_column_name) using new, old, TG_RELID;
